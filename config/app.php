...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Business / Store Day Boundary Timezone
    |--------------------------------------------------------------------------
    |
    | 営業日（例: 朝6時までは前日）の判定は常にこのタイムゾーンを用いる。
    | APP_TIMEZONE が UTC でも、店舗ローカル日付で一貫させる。
    |
    */

    'business_timezone' => env('BUSINESS_TIMEZONE', 'Africa/Tunis'),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | POS2 Settlement Actor
    |--------------------------------------------------------------------------
    */
    'pos2_settlement_actor_user_id' => (int) env('POS2_SETTLEMENT_ACTOR_USER_ID', 0),
