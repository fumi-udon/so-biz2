...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (! Schema::hasTable('dietary_badges')) {
            Schema::create('dietary_badges', function (Blueprint $table): void {
                $table->id();
        ...
        if (! Schema::hasTable('menu_item_dietary_badge')) {
            Schema::create('menu_item_dietary_badge', function (Blueprint $table): void {
                $table->id();
