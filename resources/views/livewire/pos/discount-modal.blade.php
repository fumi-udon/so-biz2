            ...
            >
                ...
                <div class="min-h-0 flex-1 space-y-3 overflow-y-auto bg-white px-3 py-3 text-sm dark:bg-slate-900">
                    ...
                    @if ($this->scope !== 'staff')
                        ...
                        @if ($this->mode === 'flat')
                            <div>
                                ...
                                <input type="number" min="0" step="100" wire:model="flatMinor"
                        ...
                        @else
                            <div>
                                ...
                                <input type="number" min="0" max="10000" wire:model="percentBasisPoints"
                                    wire:loading.attr="disabled" wire:target="submit"
                                    class="mt-1 w-full rounded-md border-gray-300 px-3 py-2 text-right tabular-nums dark:border-gray-600 dark:bg-gray-800" />
                    ...
                    <div>
                        ...
                        <input type="password" inputmode="numeric" wire:model="approverPin" wire:loading.attr="disabled" wire:target="submit"
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="reason" maxlength="255" wire:loading.attr="disabled" wire:target="submit"
                            class="mt-1 w-full rounded-md border-gray-300 px-2 py-1.5 text-sm dark:border-gray-600 dark:bg-gray-800" />
                    </div>
                </div>
