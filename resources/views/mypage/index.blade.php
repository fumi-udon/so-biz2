                ...
                @if ($staff)
                    ...
                    @if (($staff->jobLevel?->level ?? 0) != 0)
                        <div class="mt-1 rounded-lg border border-amber-300/70 bg-white/80 p-1.5 dark:border-amber-500/30 dark:bg-white/5">
                            <div class="mb-1 text-[11px] font-extrabold text-amber-700 dark:text-amber-200">🪙 Statut tip du jour</div>
                            <div class="space-y-1 text-[11px] leading-relaxed">
                                ...
                                ">
                                    @if ($lunchDenied)
                                        <span class="inline-flex items-center gap-1 rounded border border-rose-300/70 bg-white px-1.5 py-0.5 text-[11px] font-semibold text-rose-800">
                                            <span>⛔</span>
                                            <span>{{ $todayLabel }} Déjeuner : tip exclu (manager)</span>
                                        </span>
                                    @elseif ($lunchTipOnly)
                                        <span class="inline-flex items-center gap-1 rounded border border-emerald-300/70 bg-white px-1.5 py-0.5 text-[13px] font-black text-emerald-700">
                                            <span>✅</span>
                                    ...
                                    @elseif ($lunchLate)
                                        <span class="inline-flex items-center gap-1 rounded border border-slate-300/60 bg-slate-100/90 px-1.5 py-0.5 text-[11px] font-semibold text-slate-700">
                                            <span>📋</span>
                                    ...
                                    @elseif ($lunchTipEligible)
                                        <span class="inline-flex items-center gap-1 rounded border border-emerald-300/70 bg-white px-1.5 py-0.5 text-[13px] font-black text-emerald-700">
                                            <span>✅</span>
                                            <span>{{ $todayLabel }} Déjeuner : tip attribué </span>
                                        </span>
                                    @else
                                        <span class="inline-flex items-center gap-1.5 rounded-md border border-emerald-300 bg-white px-2 py-1 text-[13px] font-black text-emerald-700 shadow-sm ring-1 ring-emerald-200/70">
                                            <span class="rounded bg-emerald-600 px-1 py-0.5 text-[11px] font-extrabold tracking-wide text-white">BRAVO</span>
                                ...
                                ">
                                    ...
                                    @elseif ($dinnerTipEligible)
                                        <span class="inline-flex items-center gap-1 rounded border border-emerald-300/70 bg-white px-1.5 py-0.5 text-[13px] font-black text-emerald-700">
                                            <span>✅</span>
                                            <span>{{ $todayLabel }} Dîner : tip attribué</span>
                                        </span>
                                    @else
                                        <span class="inline-flex items-center gap-1.5 rounded-md border border-sky-300 bg-white px-2 py-1 text-[13px] font-black text-sky-700 shadow-sm ring-1 ring-sky-200/70">
                                            <span class="rounded bg-sky-600 px-1 py-0.5 text-[11px] font-extrabold tracking-wide text-white">BRAVO</span>
