...
>
    ...
    >
        <button
            type="button"
            class="w-full rounded-xl py-3.5 text-sm font-bold text-white shadow-md transition active:scale-[0.99] focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
            :style="'background-color: var(--go-primary); color: var(--go-on-primary); --tw-ring-color: var(--go-primary);'"
            @click="$store.cart.submitOrderDraft()"
